"""
Ejercicio 14: Una escuela necesita conocer cuántos alumnos cumplen años en cada mes del
...
número de legajo igual a -1. Emitir un informe donde aparezca -mes por mescuántos
